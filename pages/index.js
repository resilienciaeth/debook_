    ...
    <div className="font-larken">
        ...
        <div className="flex flex-col h-full bg-white">
          ...
          <div className="w-full bg-debook-1">
            <div className="flex flex-col ml-[3rem] py-4">
              <p className="font-larken text-[12px] text-white">From books to ebooks to now..</p>
              <h1 className="font-larken text-[40px] w-full text-white">debooks</h1>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="h-auto px-2 mb-10">
        <div className="flex flex-col mt-20">
          <div className="text-[15px] px-4 font-larken text-debook-1">
        ...
        <div className="flex flex-col justify-center items-center">
          <div className="mt-[8rem] flex flex-col items-center">
            <div className="flex flex-col px-[2rem] items-center">
              ...
              <h1 className="text-[20px] font-bold mt-6 text-white">
                Coming Soon.
              </h1>
            </div>
            <div>
      ...
      <div className="h-auto bg-circle bg-no-repeat bg-debook-1">
        <div className="flex flex-col items-center">
          <div className="flex flex-col items-center mt-[6rem] px-[2rem] mb-[9rem]">
            ...
            <p className="text-[14px] text-center mt-5 text-white">DEBOOK is a tool to tokenize books. </p>
            <p className="text-[14px] text-center text-white">DEBOOK is a marketplace for tokenized books. </p>
            <p className="text-[14px] text-center text-white">DEBOOK is a social platform for readers and authors to interact on top of their debooks.  </p>
            <div className="flex flex-row mt-16 space-x-10">
              <button className="rounded-3xl px-5 py-2 text-[15px] border-[2px] font-bold text-white">Learn More</button>
              <button className="rounded-3xl px-5 py-2 text-[15px] bg-black font-bold text-white">Publish debook</button>
            </div>
          </div>
        </div>
      </div>
