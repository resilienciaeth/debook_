...
function Home() {
  ...
  return (
    <div className="font-larken">
        ...
        <div className="flex flex-col h-full bg-white">
          <div className="nm:flex flex-row ">
            <div className="mt-[8rem] nm:mt-10 nm:w-[50%] h-[20%] nm:h-auto flex items-center nm:justify-center flex-col">
              ...
              <h1 className="text-[70px] nm:text-[120px] mt-0 font-larken font-bold text-debook-1">DEBOOK</h1>
      ...
      {/* Popular */}
      <div className="h-auto px-0 nm:px-6 mb-10">
        <div className="flex flex-col mt-20">
          <div className="text-[15px] nm:text-[55px] font-bold px-4 nm:px-20 font-larken text-debook-1">
